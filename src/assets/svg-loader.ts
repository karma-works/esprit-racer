...
export const SPRITE_SVG_MAP: Record<string, string> = {
  ...
  OBS_MUD_POOL: "obstacle-mud-pool.svg",
  OBS_LOG: "obstacle-log.svg",
  OBS_SHOCK_TOWER: "obstacle-shock-tower.svg",
  OBS_MAGNETIC_ZONE: "obstacle-magnetic-zone.svg",
  OBS_LASER_BEAM: "obstacle-laser-beam.svg",
};
...
export const preloadGameSprites = async (): Promise<void> => {
  ...
  const sprites = [
    ...
    { path: "car-esprit-road-left.svg", scales: largeScales },
    { path: "car-esprit-road-right.svg", scales: largeScales },
    { path: "car-esprit-s4.svg", scales: largeScales },
    { path: "car-esprit-s4-left.svg", scales: largeScales },
    { path: "car-esprit-s4-right.svg", scales: largeScales },
    { path: "car-m200.svg", scales: largeScales },
    { path: "car-m200-left.svg", scales: largeScales },
    { path: "car-m200-right.svg", scales: largeScales },
    ...
    { path: "background-rally.svg", scales: [1, 2] },
    { path: "background-forest.svg", scales: [1, 2] },
    { path: "obstacle-mud-pool.svg", scales: baseScales },
    { path: "obstacle-log.svg", scales: baseScales },
    { path: "obstacle-shock-tower.svg", scales: largeScales },
    { path: "obstacle-magnetic-zone.svg", scales: largeScales },
    { path: "obstacle-laser-beam.svg", scales: largeScales },
